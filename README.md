...
To update the database use this command from the Web project folder (replace `Experiments` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../Experiments.Infrastructure/Experiments.Infrastructure.csproj -s Experiments.Web.csproj
```
